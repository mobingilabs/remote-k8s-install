...
func nameForPub(name string) string {
	return fmt.Sprintf("%s.pub", name)
}

func certAndKeyToByte(cert *x509.Certificate, key *rsa.PrivateKey) ([]byte, []byte) {
	return certToByte(cert), keyToByte(key)
}
